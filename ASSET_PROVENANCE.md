...
| `docs/brand/github-preview.png` | Public website Open Graph image composed from the committed release-flow PNG. Regenerate with `node scripts/build-social-preview.mjs`; the source HTML is stored beside the image. |
