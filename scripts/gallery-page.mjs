...
const words = {
  en: {
    ...
    feedback: 'Share your first-use result', quality: 'Quality and evaluation', media: 'Demo and media kit',
  },
  zh: {
    ...
    feedback: '反馈首次试用结果', quality: '质量与评测', media: '演示与素材',
  },
};
...
<meta property="og:title" content="text2html2png — ${w.title}"><meta property="og:description" content="${w.intro}"><meta property="og:image" content="https://godvvvzzz.github.io/text2html2png/media/github-preview.png"><meta name="twitter:card" content="summary_large_image">
...
<section class="proof"><h2>${w.proof}</h2><div class="proof-items">${w.proofs.map(([title, text]) => `<article><h3>${title}</h3><p>${text}</p></article>`).join('')}</div><p class="boundary">${w.boundary}</p><div class="file-links"><a href="quality.html">${w.quality}</a><a href="${repo}/issues/new?template=trial.yml">${w.feedback}</a><a href="present.html">${w.media}</a></div></section>
