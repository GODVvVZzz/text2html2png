...
|  |  |
|---|---|
| **发布流程** · `clean`<br><img src="./skills/text2html2png/assets/gallery/release-flow-zh-clean.png" width="400" alt="clean 风格的发布流程图"><br>[Prompt 与 HTML](./skills/text2html2png/examples/release-flow-zh.html) | **系统架构** · `clean`<br><img src="./skills/text2html2png/assets/gallery/service-architecture-zh-clean.png" width="400" alt="clean 风格的系统架构图"><br>[Prompt 与 HTML](./skills/text2html2png/examples/service-architecture-zh.html) |
| **KPI 看板** · `clean`<br><img src="./skills/text2html2png/assets/gallery/support-snapshot-zh-clean.png" width="400" alt="clean 风格的客服周报看板"><br>[Prompt 与 HTML](./skills/text2html2png/examples/support-snapshot-zh.html) | **漏斗** · `glass`<br><img src="./skills/text2html2png/assets/gallery/signup-funnel-zh-glass.png" width="400" alt="glass 风格的五阶段注册漏斗"><br>[Prompt 与 HTML](./skills/text2html2png/examples/signup-funnel-zh.html) |
